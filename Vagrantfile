Vagrant.configure("2") do |config|
  ...
  config.vm.define "net-R0" do |r0|
    r0.vm.hostname = 'net-R0'
    r0.vm.network :"private_network", ip: "10.0.0.10", :name => 'vboxnet0', :adapter => 2
    r0.vm.network :"private_network", ip: "1.1.1.1", auto_config: false, virtualbox__intnet: "vlan2", :adapter => 3
  ...
  config.vm.define "net-R1" do |r1|
    r1.vm.hostname = 'net-R1'
    r1.vm.network :"private_network", ip: "10.0.0.20", :name => 'vboxnet0', :adapter => 2
    r1.vm.network :"private_network", ip: "1.1.1.1", auto_config: false, virtualbox__intnet: "vlan2", :adapter => 3
    r1.vm.network :"private_network", ip: "1.1.1.1", auto_config: false, virtualbox__intnet: "vlan4", :adapter => 4
  ...
  config.vm.define "be1" do |be1|
    ...
    be1.vm.network :"private_network", ip: "1.1.1.1", auto_config: false, virtualbox__intnet: "vlan4", :adapter => 3
  ...
  config.vm.define "be2" do |be2|
    ...
    be2.vm.network :"private_network", ip: "1.1.1.1", auto_config: false, virtualbox__intnet: "vlan4", :adapter => 3
